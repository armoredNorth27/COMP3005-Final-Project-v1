...
def Q_1(conn, execution_time):
    ...
    query = """SELECT AllEvents.player_name, AVG(statsbomb_xg) AS shot_average FROM Competitions JOIN Associated ON Competitions.season_id = Associated.season_id JOIN Matches ON Associated.match_id = Matches.match_id JOIN OccurredIn ON Matches.match_id = OccurredIn.match_id JOIN AllEvents ON OccurredIn.event_id = AllEvents.event_id JOIN Shot ON AllEvents.event_id = Shot.event_id WHERE Competitions.season_name = '2020/2021' GROUP BY AllEvents.player_name ORDER BY shot_average DESC; """
...
def Q_2(conn, execution_time):
    ...
    query = """SELECT AllEvents.player_name, COUNT(AllEvents.event_id) AS shot_count FROM Competitions JOIN Associated ON Competitions.season_id = Associated.season_id JOIN Matches ON Associated.match_id = Matches.match_id JOIN OccurredIn ON Matches.match_id = OccurredIn.match_id JOIN AllEvents ON OccurredIn.event_id = AllEvents.event_id WHERE Competitions.season_name = '2020/2021' AND AllEvents.type_name = 'Shot' GROUP BY AllEvents.player_name ORDER BY shot_count DESC; """
...
def Q_3(conn, execution_time):
    ...
    query = """SELECT AllEvents.player_name, COUNT(Shot.event_id) AS shot_count FROM Competitions JOIN Associated ON Competitions.season_id = Associated.season_id JOIN Matches ON Associated.match_id = Matches.match_id JOIN OccurredIn ON Matches.match_id = OccurredIn.match_id JOIN AllEvents ON OccurredIn.event_id = AllEvents.event_id JOIN Shot ON AllEvents.event_id = Shot.event_id WHERE Competitions.season_name = '2003/2004' AND Shot.first_time = 'true' GROUP BY AllEvents.player_name ORDER BY shot_count DESC; """
...
def Q_4(conn, execution_time):
    ...
    query = """SELECT AllEvents.team_name, COUNT(AllEvents.event_id) AS pass_count FROM Competitions JOIN Associated ON Competitions.season_id = Associated.season_id JOIN Matches ON Associated.match_id = Matches.match_id JOIN OccurredIn ON Matches.match_id = OccurredIn.match_id JOIN AllEvents ON OccurredIn.event_id = AllEvents.event_id WHERE Competitions.season_name = '2020/2021' AND AllEvents.type_name = 'Pass' GROUP BY AllEvents.team_name ORDER BY pass_count DESC; """
...
def Q_5(conn, execution_time):
    ...
    query = """SELECT Pass.recipient_name, COUNT(Pass.event_id) AS pass_count FROM Competitions JOIN Associated ON Competitions.season_id = Associated.season_id JOIN Matches ON Associated.match_id = Matches.match_id JOIN OccurredIn ON Matches.match_id = OccurredIn.match_id JOIN AllEvents ON OccurredIn.event_id = AllEvents.event_id JOIN Pass ON AllEvents.event_id = Pass.event_id WHERE Competitions.season_name = '2003/2004' and Pass.recipient_name is not Null GROUP BY Pass.recipient_name ORDER BY pass_count DESC; """
...
def Q_6(conn, execution_time):
    ...
    query = """SELECT AllEvents.team_name, COUNT(AllEvents.event_id) AS shot_count FROM Competitions JOIN Associated ON Competitions.season_id = Associated.season_id JOIN Matches ON Associated.match_id = Matches.match_id JOIN OccurredIn ON Matches.match_id = OccurredIn.match_id JOIN AllEvents ON OccurredIn.event_id = AllEvents.event_id WHERE Competitions.season_name ='2003/2004' AND AllEvents.type_name = 'Shot' GROUP BY AllEvents.team_name ORDER BY shot_count DESC; """
...
def Q_7(conn, execution_time):
    ...
    query = """SELECT AllEvents.player_name, COUNT(Pass.event_id) AS pass_count FROM Competitions JOIN Associated ON Competitions.season_id = Associated.season_id JOIN Matches ON Associated.match_id = Matches.match_id JOIN OccurredIn ON Matches.match_id = OccurredIn.match_id JOIN AllEvents ON OccurredIn.event_id = AllEvents.event_id JOIN Pass ON AllEvents.event_id = Pass.event_id WHERE Competitions.season_name = '2020/2021' AND Pass.technique_name = 'Through Ball' GROUP BY AllEvents.player_name ORDER BY pass_count DESC; """
...
def Q_8(conn, execution_time):
    ...
    query = """SELECT AllEvents.team_name, COUNT(Pass.event_id) AS pass_count FROM Competitions JOIN Associated ON Competitions.season_id = Associated.season_id JOIN Matches ON Associated.match_id = Matches.match_id JOIN OccurredIn ON Matches.match_id = OccurredIn.match_id JOIN AllEvents ON OccurredIn.event_id = AllEvents.event_id JOIN Pass ON AllEvents.event_id = Pass.event_id WHERE Competitions.season_name = '2020/2021' AND Pass.technique_name = 'Through Ball' GROUP BY AllEvents.team_name ORDER BY pass_count DESC; """
...
def Q_9(conn, execution_time):
    ...
    query = """SELECT AllEvents.player_name, COUNT(AllEvents.event_id) AS event_count FROM Competitions JOIN Associated ON Competitions.season_id = Associated.season_id JOIN Matches ON Associated.match_id = Matches.match_id JOIN OccurredIn ON Matches.match_id = OccurredIn.match_id JOIN AllEvents ON OccurredIn.event_id = AllEvents.event_id JOIN Dribble ON AllEvents.event_id = Dribble.event_id WHERE Competitions.season_name IN ('2020/2021', '2019/2020', '2018/2019') AND Dribble.outcome_name = 'Complete' GROUP BY AllEvents.player_name ORDER BY event_count DESC; """
...
def Q_10(conn, execution_time):
    ...
    query = """SELECT AllEvents.player_name, COUNT(AllEvents.event_id) AS event_count FROM Competitions JOIN Associated ON Competitions.season_id = Associated.season_id JOIN Matches ON Associated.match_id = Matches.match_id JOIN OccurredIn ON Matches.match_id = OccurredIn.match_id JOIN AllEvents ON OccurredIn.event_id = AllEvents.event_id WHERE Competitions.season_name = '2020/2021' AND AllEvents.type_name = 'Dribbled Past' GROUP BY AllEvents.player_name ORDER BY event_count ASC; """
